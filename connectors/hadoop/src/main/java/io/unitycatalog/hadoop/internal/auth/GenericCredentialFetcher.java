...
public interface GenericCredentialFetcher {
  /**
   * Return all credentials so that the responsibility of the fetcher is just to abstract the
   * underlying API (UC REST API vs Delta REST API).
   */
  List<GenericStorageCredential> createCredentials() throws ApiException;
