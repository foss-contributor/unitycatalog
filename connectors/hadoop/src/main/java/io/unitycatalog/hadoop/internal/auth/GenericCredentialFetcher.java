...
public interface GenericCredentialFetcher {
  ...
  /**
   * Credentials vended alongside the primary one for other location prefixes. Populated by {@link
   * #createCredential()}; empty unless the backing API returned multiple scoped credentials.
   */
