...
public class UCHadoopConfConstants {
  ...
  // Multi-location credential scopes. Scope i in [0, count) carries the location prefix it covers
  // plus a complete set of Hadoop credential properties under its prop. namespace;
