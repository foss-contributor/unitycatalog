  ...
  public static Map<String, String> fetchDeltaTableCredProps(
    ...
    Map<String, String> props =
        createDeltaTableCredProps(
            ...
            creds,
            appVersions);
    // Every vended scope must be usable at once: a table's reads can span locations beyond its
    // own, so each additional location's credential must be applied alongside the table's own.
